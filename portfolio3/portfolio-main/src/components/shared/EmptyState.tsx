...
export default function EmptyState({value, title, icon, message}: stateType) {
    return (
        <div
            className="w-full flex flex-col items-center text-center dark:bg-primary-bg bg-zinc-100 border border-dashed dark:border-zinc-700 border-zinc-200 rounded-md px-6 py-8">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-6 ml-4 max-w-sm">
                {message ??
                    `There are no ${value && value.toLowerCase()
