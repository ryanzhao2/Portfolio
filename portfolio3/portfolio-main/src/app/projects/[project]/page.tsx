...
import ProjectMedia from "../../../components/pages/ProjectMedia";
...
export async function generateMetadata({params}: Props): Promise<Metadata> {
    ...
    return {
        ...
        metadataBase: new URL(`https://krishspatel.com/projects/${project.slug}`),
        description: project.tagline,
        // openGraph: {
        //   images: project.cover
        //     ? urlFor(project.coverImage.image).url()
        //     : fallbackImage,
        //   url: `https://krishspatel.com/projects/${project.slug}`,
        //   title: project.name,
        //   description: project.tagline,
        // },
    };
    ...
    return (
        <main className="max-w-6xl mx-auto lg:px-16 px-8">
            <Slide>
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-start justify-between flex-wrap mb-4">
                        ...
                        <div className="flex items-center gap-x-2">
                            {(project.projectUrl || project.comingSoon) && <a
              ...
              width={project.coverImage?.width ?? 700}
              height={0}
            ...
            /> */}
                        <ProjectMedia
                            ...
                            width={project.coverMedia[0].width || 700}
                            height={0}
                        />
                    </div>
